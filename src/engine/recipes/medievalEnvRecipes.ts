...
export const MEDIEVAL_ENV_RECIPES: PropRecipe[] = [
    ...
    // ── Transport ──
    {
        id: 'env-med-horse', name: 'Saddled Horse', era: 'medieval', category: 'environment',
        nodes: [
            { label: 'Body', primitive: 'box', position: [0, 1.2, 0], scale: [2, 1, 0.8], material: 'default', color: '#6a4a2a' },
            { label: 'Chest', primitive: 'sphere', position: [-0.8, 1.3, 0], scale: [0.9, 0.9, 0.8], material: 'default', color: '#6a4a2a' },
            { label: 'Haunches', primitive: 'sphere', position: [0.8, 1.2, 0], scale: [0.8, 0.8, 0.7], material: 'default', color: '#6a4a2a' },
            { label: 'Neck', primitive: 'cylinder', position: [-1.2, 1.8, 0], scale: [0.3, 1.2, 0.25], rotation: [0, 0, 25], material: 'default', color: '#6a4a2a' },
            { label: 'Head', primitive: 'box', position: [-1.6, 2.2, 0], scale: [0.8, 0.4, 0.3], material: 'default', color: '#6a4a2a' },
            { label: 'Leg FL', primitive: 'cylinder', position: [-0.6, 0.5, -0.3], scale: [0.1, 1, 0.1], material: 'default', color: '#5a3a1a' },
            { label: 'Leg FR', primitive: 'cylinder', position: [-0.6, 0.5, 0.3], scale: [0.1, 1, 0.1], material: 'default', color: '#5a3a1a' },
            { label: 'Leg BL', primitive: 'cylinder', position: [0.6, 0.5, -0.3], scale: [0.1, 1, 0.1], material: 'default', color: '#5a3a1a' },
            { label: 'Leg BR', primitive: 'cylinder', position: [0.6, 0.5, 0.3], scale: [0.1, 1, 0.1], material: 'default', color: '#5a3a1a' },
            { label: 'Saddle', primitive: 'box', position: [0, 1.8, 0], scale: [0.6, 0.15, 0.6], material: 'wood', color: '#3a2010' },
            { label: 'Mane', primitive: 'box', position: [-0.8, 2, 0], scale: [0.8, 0.3, 0.05], material: 'default', color: '#1a1008' },
            { label: 'Tail', primitive: 'box', position: [1.3, 1.2, 0], scale: [0.5, 0.04, 0.15], rotation: [0, 0, -30], material: 'default', color: '#1a1008' },
        ],
    },
    {
        id: 'env-med-oxcart', name: 'Ox Cart', era: 'medieval', category: 'environment',
        nodes: [
            { label: 'Ox Body', primitive: 'box', position: [-2, 0.8, 0], scale: [1.8, 1.2, 0.9], material: 'default', color: '#6a4a2a' },
            { label: 'Ox Head', primitive: 'box', position: [-3.2, 1.2, 0], scale: [0.6, 0.5, 0.5], material: 'default', color: '#6a4a2a' },
            { label: 'Horn L', primitive: 'cone', position: [-3.2, 1.6, -0.25], scale: [0.06, 0.4, 0.06], rotation: [0, 0, 20], material: 'default', color: '#ddd8c0' },
            { label: 'Horn R', primitive: 'cone', position: [-3.2, 1.6, 0.25], scale: [0.06, 0.4, 0.06], rotation: [0, 0, -20], material: 'default', color: '#ddd8c0' },
            { label: 'Ox Leg FL', primitive: 'cylinder', position: [-2.5, 0.3, -0.35], scale: [0.08, 0.6, 0.08], material: 'default', color: '#5a3a1a' },
            { label: 'Ox Leg FR', primitive: 'cylinder', position: [-2.5, 0.3, 0.35], scale: [0.08, 0.6, 0.08], material: 'default', color: '#5a3a1a' },
            { label: 'Ox Leg BL', primitive: 'cylinder', position: [-1.5, 0.3, -0.35], scale: [0.08, 0.6, 0.08], material: 'default', color: '#5a3a1a' },
            { label: 'Ox Leg BR', primitive: 'cylinder', position: [-1.5, 0.3, 0.35], scale: [0.08, 0.6, 0.08], material: 'default', color: '#5a3a1a' },
            { label: 'Yoke', primitive: 'box', position: [-1, 1.2, 0], scale: [0.1, 0.1, 1.2], material: 'wood', color: '#5a3a18' },
            { label: 'Cart Bed', primitive: 'box', position: [1, 0.7, 0], scale: [2.5, 0.1, 1.2], material: 'wood', color: '#6a4a25' },
            { label: 'Cart Side L', primitive: 'box', position: [1, 1, -0.6], scale: [2.5, 0.5, 0.06], material: 'wood', color: '#5a3a18' },
            { label: 'Cart Side R', primitive: 'box', position: [1, 1, 0.6], scale: [2.5, 0.5, 0.06], material: 'wood', color: '#5a3a18' },
            { label: 'Wheel L', primitive: 'torus', position: [1, 0.5, -0.8], scale: [0.5, 0.5, 0.06], material: 'wood', color: '#4a3015' },
            { label: 'Wheel R', primitive: 'torus', position: [1, 0.5, 0.8], scale: [0.5, 0.5, 0.06], material: 'wood', color: '#4a3015' },
            { label: 'Grain Sack', primitive: 'sphere', position: [0.5, 1.1, 0], scale: [0.5, 0.4, 0.4], material: 'fabric', color: '#c8b888' },
        ],
    },
]
