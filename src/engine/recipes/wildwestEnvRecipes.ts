...
export const WILDWEST_ENV_RECIPES: PropRecipe[] = [
    ...
    // ── Transport ──
    {
        id: 'env-ww-stagecoach', name: 'Stagecoach', era: 'wild-west', category: 'environment',
        nodes: [
            { label: 'Cabin', primitive: 'box', position: [0, 1.5, 0], scale: [2.5, 1.8, 1.5], material: 'wood', color: '#7a2222' },
            { label: 'Gold Trim', primitive: 'box', position: [0, 1.5, 0.76], scale: [2.3, 0.1, 0.02], material: 'gold', color: '#bb9933' },
            { label: 'Luggage Rack', primitive: 'box', position: [0, 2.5, 0], scale: [2.5, 0.08, 1.5], material: 'wood', color: '#5a1515' },
            { label: 'Driver Bench', primitive: 'box', position: [-1.6, 2, 0], scale: [0.6, 0.1, 1], material: 'wood', color: '#5a3a18' },
            { label: 'Wheel FL', primitive: 'torus', position: [-0.8, 0.5, -1], scale: [0.5, 0.5, 0.06], material: 'wood', color: '#4a3015' },
            { label: 'Wheel FR', primitive: 'torus', position: [-0.8, 0.5, 1], scale: [0.5, 0.5, 0.06], material: 'wood', color: '#4a3015' },
            { label: 'Wheel RL', primitive: 'torus', position: [0.8, 0.5, -1], scale: [0.6, 0.6, 0.08], material: 'wood', color: '#4a3015' },
            { label: 'Wheel RR', primitive: 'torus', position: [0.8, 0.5, 1], scale: [0.6, 0.6, 0.08], material: 'wood', color: '#4a3015' },
            { label: 'Lamp L', primitive: 'sphere', position: [-1.5, 2, -0.6], scale: [0.1, 0.12, 0.1], material: 'gold', color: '#bb9933' },
            { label: 'Lamp R', primitive: 'sphere', position: [-1.5, 2, 0.6], scale: [0.1, 0.12, 0.1], material: 'gold', color: '#bb9933' },
            { label: 'Tongue', primitive: 'box', position: [-2.5, 0.8, 0], scale: [2, 0.06, 0.06], material: 'wood', color: '#5a3a18' },
        ],
    },
    {
        id: 'env-ww-horse', name: 'Saddled Horse (Western)', era: 'wild-west', category: 'environment',
        nodes: [
            { label: 'Body', primitive: 'box', position: [0, 1.1, 0], scale: [1.8, 0.9, 0.7], material: 'default', color: '#c8a050' },
            { label: 'Chest', primitive: 'sphere', position: [-0.7, 1.2, 0], scale: [0.8, 0.8, 0.7], material: 'default', color: '#c8a050' },
            { label: 'Haunches', primitive: 'sphere', position: [0.7, 1.1, 0], scale: [0.7, 0.7, 0.6], material: 'default', color: '#c8a050' },
            { label: 'Neck', primitive: 'cylinder', position: [-1.1, 1.7, 0], scale: [0.25, 1.1, 0.22], rotation: [0, 0, 25], material: 'default', color: '#c8a050' },
            { label: 'Head', primitive: 'box', position: [-1.5, 2.1, 0], scale: [0.7, 0.35, 0.28], material: 'default', color: '#c8a050' },
            { label: 'Blaze', primitive: 'box', position: [-1.8, 2.1, 0], scale: [0.15, 0.2, 0.05], material: 'default', color: '#eeeeee' },
            { label: 'Leg FL', primitive: 'cylinder', position: [-0.5, 0.45, -0.25], scale: [0.09, 0.9, 0.09], material: 'default', color: '#b89040' },
            { label: 'Leg FR', primitive: 'cylinder', position: [-0.5, 0.45, 0.25], scale: [0.09, 0.9, 0.09], material: 'default', color: '#b89040' },
            { label: 'Leg BL', primitive: 'cylinder', position: [0.5, 0.45, -0.25], scale: [0.09, 0.9, 0.09], material: 'default', color: '#b89040' },
            { label: 'Leg BR', primitive: 'cylinder', position: [0.5, 0.45, 0.25], scale: [0.09, 0.9, 0.09], material: 'default', color: '#b89040' },
            { label: 'Western Saddle', primitive: 'box', position: [0, 1.7, 0], scale: [0.5, 0.2, 0.55], material: 'wood', color: '#4a2a10' },
            { label: 'Saddle Horn', primitive: 'cylinder', position: [-0.15, 1.9, 0], scale: [0.05, 0.2, 0.05], material: 'wood', color: '#4a2a10' },
            { label: 'Mane', primitive: 'box', position: [-0.7, 1.9, 0], scale: [0.7, 0.25, 0.04], material: 'default', color: '#eee8d0' },
            { label: 'Tail', primitive: 'box', position: [1.2, 1.1, 0], scale: [0.4, 0.04, 0.12], rotation: [0, 0, -25], material: 'default', color: '#eee8d0' },
        ],
    },
    {
        id: 'env-ww-handcar', name: 'Railroad Handcar', era: 'wild-west', category: 'environment',
        nodes: [
            { label: 'Platform', primitive: 'box', position: [0, 0.4, 0], scale: [1.5, 0.08, 1.2], material: 'wood', color: '#6a4a25' },
            { label: 'Rim', primitive: 'box', position: [0, 0.45, 0], scale: [1.6, 0.04, 1.3], material: 'chrome', color: '#555555' },
            { label: 'Wheel FL', primitive: 'cylinder', position: [-0.5, 0.2, -0.7], scale: [0.2, 0.06, 0.2], rotation: [90, 0, 0], material: 'chrome', color: '#666666' },
            { label: 'Wheel FR', primitive: 'cylinder', position: [-0.5, 0.2, 0.7], scale: [0.2, 0.06, 0.2], rotation: [90, 0, 0], material: 'chrome', color: '#666666' },
            { label: 'Wheel RL', primitive: 'cylinder', position: [0.5, 0.2, -0.7], scale: [0.2, 0.06, 0.2], rotation: [90, 0, 0], material: 'chrome', color: '#666666' },
            { label: 'Wheel RR', primitive: 'cylinder', position: [0.5, 0.2, 0.7], scale: [0.2, 0.06, 0.2], rotation: [90, 0, 0], material: 'chrome', color: '#666666' },
            { label: 'Handle Post L', primitive: 'cylinder', position: [0, 0.7, -0.3], scale: [0.04, 0.6, 0.04], material: 'chrome', color: '#444444' },
            { label: 'Handle Post R', primitive: 'cylinder', position: [0, 0.7, 0.3], scale: [0.04, 0.6, 0.04], material: 'chrome', color: '#444444' },
            { label: 'Handle Bar', primitive: 'cylinder', position: [0, 0.9, 0], scale: [0.03, 0.7, 0.03], rotation: [90, 0, 0], material: 'chrome', color: '#555555' },
            { label: 'Rail L', primitive: 'box', position: [0, 0.03, -0.65], scale: [3, 0.05, 0.05], material: 'chrome', color: '#666666' },
            { label: 'Rail R', primitive: 'box', position: [0, 0.03, 0.65], scale: [3, 0.05, 0.05], material: 'chrome', color: '#666666' },
            { label: 'Tie 1', primitive: 'box', position: [-0.8, 0.02, 0], scale: [0.08, 0.04, 1.5], material: 'wood', color: '#5a3a18' },
            { label: 'Tie 2', primitive: 'box', position: [0.8, 0.02, 0], scale: [0.08, 0.04, 1.5], material: 'wood', color: '#5a3a18' },
        ],
    },
]
